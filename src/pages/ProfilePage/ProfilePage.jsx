        ...
        <main className="signupPage-container">
          <div className="signupPage-header-wrapper">
            ...
            <div className="flex-centered gap-8">
              <h3
                className="signupPage_action-login cursor-pointer"
                onClick={() => {
                  !getLocalToken
                    ? dispatch({ type: "SHOW_LOGIN", payload: true })
                    : logOutUser();
          ...
          >
            <div className="signupPage_left_login-info">
              <div className="signupPage_left_login-info_title-wrapper">
                <p className="signupPage_left_login-info_title-text">
                  Signup information
                </p>
                <p className="signupPage_left_login-info_title-required">
              ...
              <div className="login-info_input-wrapper">
                <input
                  ...
                  type="email"
                  name="/"
                  className="signupPage_left_login-info_input email"
              ...
              <div className="login-info_input-wrapper">
                <input
                  ...
                  type="password"
                  name="/"
                  className="signupPage_left_login-info_input pass"
              ...
              <div className="signupPage_left_login-info_valid-pass-wrapper">
                <p className="login-info_valid-pass_left">
                  Minimum 8 characters
                </p>
                <p className="login-info_valid-pass_right">
                  Password Strength - - -
                </p>
              </div>
            </div>
            <div className="signupPage_right_billing-info_terms-wrapper">
              <input
                ...
                type="checkbox"
                name="/"
                className="billing-info_terms-checkbox"
              />
              <p className="billing-info_terms-desc">
                I agree to receive information by email about offers, services,
                products and events from Madre Linda or other group companies,
                in accordance with the Privacy PolicyNew tab.
                <br />
                <br />
                By creating an account, you agree to accept the General Terms
                and Conditions of UseNew tab and that your data will be
                processed in compliance with the Privacy PolicyNew tab of Madrè
                Linda.
              </p>
            </div>
            <button
              type="submit"
              className="signupPage_action-create-ac btn-hover-rv cursor-pointer"
            >
              Create an account
            </button>
          </form>
          ...
          {isAddress ? (
            ...
            <form
              className="signupPage_right billing-info"
              onSubmit={(e) => addressSubmitHandler(e)}
            >
              <div className="billing-info_input-wrapper">
                <div className="signupPage_right_billing-info_title-wrapper">
                  <p className="signupPage_right_billing-info_title-text">
                    Billing information
                  </p>
                </div>
                <div className="personal-info_input-wrapper first-name">
                  <input
                    ...
                    type="text"
                    name="/"
                    className="signupPage_personal-info_input title"
                    id="title"
                  />
                  <input
                    required
                    ...
                    type="text"
                    name="/"
                    className="signupPage_personal-info_input first-name"
                    id="first-name"
                  />
                </div>
                <div className="personal-info_input-wrapper last-name">
                  <input
                    ...
                    type="text"
                    name="/"
                    className="signupPage_personal-info_input last-name"
                  />
                </div>
                <div className="personal-info_input-wrapper contact-no">
                  <input
                    ...
                    type="text"
                    name="/"
                    className="signupPage_personal-info_input contact-no"
                  />
                </div>
                <input
                  required
                  ...
                  type="text"
                  name="/"
                  className="signupPage_right_billing-info_input email"
                />
                <input
                  required
                  onChange={(e) =>
                ...
                <input
                  ...
                  type="number"
                  name="/"
                  className="signupPage_right_billing-info_input pass"
                />
              </div>
              <div className="signupPage_right_billing-info_terms-wrapper">
                <input
