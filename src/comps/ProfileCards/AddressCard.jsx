...
function AddressCard({initialAddressState, address, setAddress, setIsAddress}) {
    ...
    <div className='AddressCard'>
        <h2 className="AddressCard-title flex justify-space-between">
            ...
            <span className="add-icons">
                <AiOutlineDelete onClick={addDeleteHandler} className='icon-add' size="1em" />
                <AiOutlineEdit onClick={() => setIsAddress(false)} className='icon-add' size="1em"/>
            </span>
        </h2>
        <div className="AddressCard-main">
            <ul className='AddressCard-list'>
                <li className="AddressCard-list-item name flex-centered justify-start">
                    ...
                    <p className="AddressCard-list-item-title name-title">{address.firstname}</p>
