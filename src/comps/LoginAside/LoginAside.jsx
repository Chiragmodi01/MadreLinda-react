...
function LoginAside() {
  ...
  return (
    <div className={state.showLogin ? "loginAside" : "loginAsideHidden"}>
      <div
        className="loginpage_blur"
        onClick={() => dispatch({ type: "SHOW_LOGIN", payload: false })}
      ></div>
      <main className="loginPage-container">
        <div className="loginPage_top">
          <div className="loginPage_header">
            ...
            <p className="loginPage_header_desc">
          ...
          >
            <input
              ...
              type="email"
              name="/"
              className="loginPage_form_input input-email"
              value={userDataLogin.email}
              onChange={(e) =>
                setUserDataLogin({ ...userDataLogin, email: e.target.value })
              }
            />
            <input
              required
              ...
              type="password"
              name="/"
              className="loginPage_form_input input-pass"
            ...
            <div className="loginPage_form_checkbox-wrapper">
              <input
                ...
                name="/"
                id="remember-me"
                className="loginPage_form_checkbox"
              />
              <label
                for="remember-me"
                className="loginPage_form_checkbox-label"
              >
                Remember me
              </label>
            </div>
            <button
              type="submit"
              className="loginPage_from_submit cursor-pointer"
            >
              Login
            </button>
            <button
              className="loginPage_from_action-forgot-pass"
              onClick={(e) => fillGuestUser(e)}
            >
              Guest Login
            </button>
          </form>
        ...
        <div className="loginPage_bottom">
          <div className="loginPage_bottom_header-wrapper">
            <h4 className="loginPage_bottom_header_title">
              Get an account now
            </h4>
            <p className="loginPage_bottom_header_desc">
              Save credit card details for faster shopping Manage your order
              history Gain access to your Wishlist
            </p>
          </div>
          <button
            className="loginPage_bottom_action cursor-pointer"
            onClick={() => dispatch({ type: "SHOW_LOGIN", payload: false })}
          >
            Register now
          </button>
