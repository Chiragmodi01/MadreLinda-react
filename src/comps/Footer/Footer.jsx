    ...
    <footer>
      <div className="footer-features-container">
        <div className="footer-features_feature feature-1">
          <div className="footer-features_feature-title">
            ...
            <IoIosArrowForward
              size="1.5em"
              className="footer-features_features_title_arrow-icon arrow-right"
            />
          </div>
          <p className="footer-features_feature-desc">
            Checkout out new trending collection
          </p>
        </div>
        ...
        <div className="footer-features_feature feature-3">
          ...
          <p className="footer-features_feature-desc">
            Checkout our new Botique collection.
          </p>
        </div>
      </div>
      ...
      <div className="footer-main">
        <div className="footer-main_top">
          <Link to="/">
            {" "}
            <p className="footer-main_brand cursor-pointer">Madré Linda</p>{" "}
          </Link>
          ...
          <div className="footer-main_contact-section">
            <p className="footer-main_contact-section_subscribe">
              Please subscribe us to know more
            </p>
            <div className="footer-main_contact-wrapper">
              ...
              <label
                ...
                className="subscribe-input-btn cursor-pointer"
              >
                Subsscribe
              </label>
            </div>
        ...
        <div className="footer-main_mid-cards-wrapper">--accepted cards--</div>
        <div className="footer-main_bottom">
          <p className="footer-main_bottom_text">
            © Madrè Linda 2022. All rights reserved. Site – managed by{" "}
            <a
              href="https://github.com/Chiragmodi01"
              target="_blank"
              className="auther-name_footer"
            >
              {" "}
              Chirag modi
            </a>{" "}
